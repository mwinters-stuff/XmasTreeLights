...
#else
NeoPatterns bar16 = NeoPatterns(5, PIN_NEOPIXEL_BAR_16, NEO_RGB + NEO_KHZ800, &allPatterns);
#endif
...
void setup() {
  ...
  switches.addButtonPin(D5, [&](uint8_t pin, uint32_t msPressed){
    onButtonPressed(msPressed);
  },true);
...
void allPatterns(NeoPatterns * aLedsPtr) {
    ...
    case 0:
        // Cylon
        aLedsPtr->ScannerExtended(NeoPatterns::Wheel(tColor), 1, tDuration, 2, FLAG_SCANNER_EXT_CYLON);
        break;
    case 1:
        // Heartbeat
